    ...
    return [
      { 
        ...
        cards: [
          ...
          {
            id: 2,
            content: 'Criar interface do Pipefy',
            labels: ['#7159c1'],
            user: 'https://api.adorable.io/avatars/285/abott@adorable.png'
          },
          {
      ...
      { 
        ...
        cards: [
          {
            id: 10,
            content: 'Fazer deploy e CI com React Native',
            labels: [],
          },
          {
            id: 12,
          ...
          {
            id: 13,
            content: 'Fazer "Internacionalização de aplicações Node.js, ReactJS e React Native"',
            labels: ['#7159c1'],
          }
        ]
      },
